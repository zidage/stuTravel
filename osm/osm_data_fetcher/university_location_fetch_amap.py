...
city = []
input_file = 'map_data/provinces.json'
with open('provinces.json', 'r', encoding='utf-8') as province_list:
    data = json.load(province_list)
    regions = []
    for r in data:
        regions.append(r['name'])
    output_file = 'map_data/china_university.json'
    with open(output_file, 'w') as f: 
        f.write("{\n")
        
        for region in regions:
            api_url = f'https://restapi.amap.com/v3/place/text?types=141201&region={region}&key=f4e0a0d57c05463b57ad9a9c262d3949'
